...
const Navbar = (props: Props) => {
  return (
    <nav className="fixed flex justify-between w-screen glass dark:bg-black p-3">
      <Link href={routes.HOME}>
        <article className="flex gap-2 w-fit items-center">
          ...
          <div>
            <h1 className="font-[900] sm:text-xl text-lg tracking-wider uppercase dark:text-primary text-white cursor-pointer">
              Khelzop
            </h1>
